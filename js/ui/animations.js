...
export const cachedEls = { track: null, tabs: null, glassActive: null, glassLeft: null, glassRight: null };
...
export function syncBackgrounds(currentIndex = 0, isInstant = false) {
    ...
    tabs.forEach((tab, i) => {
        ...
        tab.style.transition = isInstant ? 'transform 0s' : 'transform 0.35s cubic-bezier(0.4, 0, 0.2, 1)';
