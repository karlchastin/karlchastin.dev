export function initBgEffects() {
  ...
  overlayContainers.forEach(container => {
    ...
    observer.observe(document.body, { attributes: true, attributeFilter: ['data-tab-effect-visible'] });

    if (document.body.getAttribute('data-tab-effect-visible') === 'true' && document.body.getAttribute('data-active-tab') === targetTab) {
      container.classList.add('active');
      startEffect();
    }
  });
