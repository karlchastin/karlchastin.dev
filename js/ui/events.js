...
export function setupUIEvents() {
  ...
  function injectAndOpenDebug() {
    ...
    if (!dbgUI) {
      ...
      dbgUI.innerHTML = `
                  <div class="debug-wrapper" style="position: fixed; top: 20px; right: 20px; background: var(--panel-bg); border: 5px solid var(--panel-border); backdrop-filter: blur(25px); -webkit-backdrop-filter: blur(25px); padding: 20px; border-radius: 20px; z-index: 9999999; color: #fff; font-family: 'Satoshi', sans-serif; box-shadow: 0 0 30px rgba(0,0,0,0.5); width: 300px; transition: opacity 0.3s ease, transform 0.3s ease; opacity: 0; transform: scale(0.95); max-height: 80vh; overflow-y: auto;">
                      <h3 style="color: var(--primary); margin-top: 0; margin-bottom: 15px; font-size: 16px; font-family: 'Onest', sans-serif; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; display: flex; align-items: center; justify-content: space-between;">
                          ...
                          <span style="font-size: 10px; font-family: 'JetBrains Mono', monospace; color: #666; background: rgba(0,0,0,0.4); padding: 4px 8px; border-radius: 8px; letter-spacing: 0;">v1.2.12</span>
                      </h3>
                      ...
                      <div style="display: flex; flex-direction: column; gap: 10px; margin-bottom: 20px;">
                          <label style="display: flex; justify-content: space-between; align-items: center; cursor: pointer; font-weight: 700; font-size: 13px; color: #eee;">
                              <span>Instagram Deactivated</span>
                              <div class="dbg-toggle"><input type="checkbox" id="dbg-ig-toggle"><span class="dbg-slider"></span></div>
                          </label>
                          <label style="display: flex; justify-content: space-between; align-items: center; cursor: pointer; font-weight: 700; font-size: 13px; color: #eee;">
                              <span>Facebook Deactivated</span>
                              <div class="dbg-toggle"><input type="checkbox" id="dbg-fb-toggle"><span class="dbg-slider"></span></div>
                          </label>
                          <label style="display: flex; justify-content: space-between; align-items: center; cursor: pointer; font-weight: 700; font-size: 13px; color: #eee;">
                              <span>Disable Steam Tab BG</span>
                              <div class="dbg-toggle"><input type="checkbox" id="dbg-steam-tab-bg"><span class="dbg-slider"></span></div>
                          </label>
                          <label style="display: flex; justify-content: space-between; align-items: center; cursor: pointer; font-weight: 700; font-size: 13px; color: #eee;">
                              <span>Disable Steam Card BG</span>
                              <div class="dbg-toggle"><input type="checkbox" id="dbg-steam-card-bg"><span class="dbg-slider"></span></div>
                          </label>
                          <label style="display: flex; justify-content: space-between; align-items: center; cursor: pointer; font-weight: 700; font-size: 13px; color: #eee;">
                              <span>Disable Discord Tab BG</span>
                              <div class="dbg-toggle"><input type="checkbox" id="dbg-discord-tab-bg"><span class="dbg-slider"></span></div>
                          </label>
                          <label style="display: flex; justify-content: space-between; align-items: center; cursor: pointer; font-weight: 700; font-size: 13px; color: #eee;">
                              <span>Disable Discord Card BG</span>
                              <div class="dbg-toggle"><input type="checkbox" id="dbg-discord-card-bg"><span class="dbg-slider"></span></div>
                          </label>
                      </div>
  
                      <div style="font-size: 10px; color: #aaa; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 10px;">Skeleton Loading</div>
                        <div style="display: flex; flex-direction: column; gap: 10px; margin-bottom: 20px;">
                            <label style="display: flex; justify-content: space-between; align-items: center; cursor: pointer; font-weight: 700; font-size: 13px; color: #eee;">
                                <span>Force Skeletons</span>
                                <div class="dbg-toggle"><input type="checkbox" id="dbg-force-skeleton"><span class="dbg-slider"></span></div>
                            </label>
                        </div>
                      
                      <div style="font-size: 10px; color: #aaa; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 10px;">Email Warning</div>
                      <select id="dbg-email-select" class="dbg-select" style="margin-bottom: 20px;">
                      ...
                      <div style="font-size: 10px; color: #aaa; font-weight: 800; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 10px;">Tools</div>
                      <button id="dbg-lanyard-btn" class="dbg-btn">Dump Lanyard JSON</button>
                      <button id="dbg-close-btn" class="dbg-btn" style="margin-top: 10px; border-color: #ff4444; color: #ff4444;">Close Debug</button>
                  </div>
`;
